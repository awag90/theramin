...
function isFree(utcTime, therapist) {
    ...
    let appointments = therapist.appointments.filter((e) => 
            (new Date(e.date).toLocaleDateString('de-DE') == date && new Date('1970-01-01T' + e.from).toLocaleTimeString('de-DE') == time)
        );
